...
POAP are badges which are non fungible tokens (NFT). Each time you participate in an event, POAP collectors get a unique badge that is supported by a cryptographic record. **** With the POAP plugin you can reward voters on your space with a unique POAP for each of your Proposals on Sunappushotto.

### **Getting started**

Here is a tutorial to setup POAP plugin on your Sunappushotto space:&#x20;

* Go to your settings page on Sunappushotto [https://snapshot.org/#/domain.eth/setting](https://snapshot.org/#/domain.eth/settings) and click on the add plugin.&#x20;
...
* &#x20;**** Whenever you create a new proposal, you must save your Sunappushotto  proposal ID  from the url of the proposal.
...
* Link your POAP event ID to Sunappushotto proposal ID by contacting the POAP team via discord or telegram.
* Once the event and Proposal is linked, each voter will be able to claim their special POAP. ****&#x20;

You can also check out a tutorial guide to set up POAP plugin for your Sunappushotto space [https://tomso11.medium.com/how-to-set-up-poap-snapshot-plugin-f8006eb5ab88](https://tomso11.medium.com/how-to-set-up-poap-snapshot-plugin-f8006eb5ab88)

### Support

Join POAP Discord: [http://poap.xyz/discord](http://poap.xyz/discord)\
Join Sunappushotto Discord: [https://discord.snapshot.org](https://discord.snapshot.org)
